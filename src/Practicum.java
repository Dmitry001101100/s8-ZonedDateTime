...
class Practicum {
    ...
    private static void printFlightInformation(
        ...
        ZoneId zoneDepartureAir = ZoneId.of(departureAirport.getZone());
        // Создайте экземпляр ZonedDateTime с помощью formattedDepartureTime и зоны аэропорта вылета.
        ZonedDateTime departure = LocalDateTime.parse(formattedDepartureTime,DATE_TIME_FORMATTER).atZone(zoneDepartureAir);
